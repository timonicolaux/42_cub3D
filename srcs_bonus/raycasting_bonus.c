...
void	check_if_wall_hit(t_data *data)
{
	...
	data->map.map[data->ray_y][data->ray_x] == 'D' || \
	data->map.map[data->ray_y][data->ray_x] == 'O')
	{
		data->wall_hit = 1;
		if (data->map.map[data->ray_y][data->ray_x] == 'D' || \
		data->map.map[data->ray_y][data->ray_x] == 'O')
			data->wall += 4;
	}
}
